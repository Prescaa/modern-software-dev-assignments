...
Fix is_valid_password. Missing: uppercase check, special char check. Rules: 8+ chars, lowercase, uppercase, digit, special (!@#$%^&*()-_), no spaces. Check ALL conditions. Output only code.
